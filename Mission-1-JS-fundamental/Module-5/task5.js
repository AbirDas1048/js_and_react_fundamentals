...
console.log(getChaseVerdict(150, 140, 1));	// "Need 10 runs in 1 balls | Almost Impossible"
console.log(getChaseVerdict(150, 140, -5));	// "Lost"
console.log(getChaseVerdict(-150, 140, 0));	// "Won"
console.log(getChaseVerdict(0, 0, 0));	// "Won"